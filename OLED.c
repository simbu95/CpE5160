...
void OLED_Set_Cursor (volatile SPI_t *OLED_port, uint8_t position)
{
	...
	temp8=(position&0x0F);
	GPIO_Output_Clear(&OLED_SS_Port,OLED_SS_Pin); //OLED_SS_Control(0);
	temp8=SPI_Transmit(OLED_port, (0x00|temp8));    // least sig. nibble of cursor address
	GPIO_Output_Set(&OLED_SS_Port,OLED_SS_Pin); //OLED_SS_Control(1);
	temp8=(position>>4);
	GPIO_Output_Clear(&OLED_SS_Port,OLED_SS_Pin); //OLED_SS_Control(0);
	temp8=SPI_Transmit(OLED_port, (0x10|temp8));    // most sig. nibble of cursor address
	GPIO_Output_Set(&OLED_SS_Port,OLED_SS_Pin); //OLED_SS_Control(1);
}
